 ...
 * 
 * 1) A base case (so it can stop running)
 * 2) A task to do over and over again (recursion)
 *
...
int printnum2(int n){
	...
	if (n / 10 > 0) //Our base case: If there is still a digit, run printnum2 recursively
